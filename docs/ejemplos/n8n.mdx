...
### Vídeo 1. Instalación
 En este vídeo aprenderás paso a paso a instalar <strong>n8n</strong>, una potente herramienta de automatización. 
...
### CÓDIGO Servidor
Mediante el siguiente código podemos transformar nuestra aplicación, en un pequeño servidro API Rest que 
recibiría una petición HTTP mediante POST en el puerto 8080.
