...
2. **Envío a la API OCR:**  
   Usar un servicio (por ejemplo, **OCR.Space**, **Google Vision API**, **Tesseract OCR**, o un **servicio local en Java o Python**) que reciba la imagen y devuelva el texto o los campos detectados.
...
4. **Visualización o registro de resultados:**  
   - Mostrar el JSON en una interfaz simple (web o Java Swing).  
   - *(Opcional)* Guardar los datos extraídos en un archivo o base de datos.  
...
1. **Imagen escaneada** del documento físico completado.  
